...
var openInvitation = function openInvitation(event) {
  ...
  if (invitationOpened) {
    for (var _i = 0; _i < btn_open.length; _i++) {
      btn_open[_i].classList.add("d-none");
    }
  }
...
// buka undangan (PERBAIKAN)
var btn_open = document.querySelectorAll("#btn_open");

for (var _i2 = 0; _i2 < btn_open.length; _i2++) {
  btn_open[_i2].addEventListener("click", openInvitation, false);
}

// Penutup fungsi bawaan tema Anda (pastikan ini tidak error)
}();
/******/ })();